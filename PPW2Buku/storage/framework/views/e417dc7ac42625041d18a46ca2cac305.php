...
<body class="bg-light">
    ...
    <?php if(count($data_buku)): ?>
        <div class="alert alert-success alert-dismissible fade show" role="alert" aria-live="assertive">
            Ditemukan <strong><?php echo e(count($data_buku)); ?></strong> data dengan kata: <strong><?php echo e($cari); ?></strong>.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php else: ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <h5>Data "<?php echo e($cari); ?>" tidak ditemukan</h5>
            <a href="/buku" class="btn btn-warning">Kembali</a>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
    <?php endif; ?>
</body>
</html><?php /**PATH D:\KULIAH\SEMESTER 3\TUGAS\Praktikum Pemrograman Web 2\code\pertemuan5\resources\views/buku/search.blade.php ENDPATH**/ ?>